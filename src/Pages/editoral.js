                ...
                >
                    ...
                    >
                        ...
                        <div className="textSection">
                            ...
                            <p className="bioText" id="topBorder">This is the section where I write about my writing… very meta, I know.</p>
                            ...
                            <h3 className="bioText"><b className="boldWordsTitle">Words, Words, and More Words</b></h3>
                            <p className="bioText" id="topBorder">With over 400+ published articles to my name, including everything from news stories, long-form features, satire, listicles, interactive quizzes, interviews, and beyond, I’ve worked my way into becoming a multi-faceted and adaptable writer.</p>
