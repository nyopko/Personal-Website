                ...
                >
                    ...
                    >
                        <div className="textSection">
                            <h3 className="bioText"><b>Hey, I’m Nick.</b></h3> 
                        ...
                        <div className="textSection">
                            <h3 className="bioBold"><b>Digital Marketing Fun</b></h3>
                            <p className="bioText">I gravitated towards digital marketing because I’ve always enjoyed how creative the work could be, and how much technology and science it implemented. Plus, anything with the word “digital” in front of it just sounds cool. <b>While solving problems and implementing creative solutions in both the medical equipment and entertainment industries</b> (not quite peanut butter and jelly, but a good mix nonetheless) I realized how much more there is to the field and made the decision to dive in a little deeper.</p>
                            <p className="bioText">I understood that my strengths were both <b>technology</b> and <b>communication</b>. As I said earlier, the former was from the technological ineptitude of my family, while the latter was developed due to the fact that my family is the loud Italian type and the only way I could get someone to pass the food was to speak up (see: yell).</p>
                            <p className="bioText">Which brings me to the next pillar in my professional life...</p> 
                        </div>

                        <div className="textSection">
                            <h3 className="bioBold"><b>Words and Such</b></h3>
                            ...
                            <p className="bioText">Through equal parts of my <b>hard work</b>, excellent advice, and my bosses’ forgiveness when my attempts at including puns fell flat, I was able to rise through the ranks and <b>become an associate editor</b>. This has allowed me to talk to artists I admire, cover some of the world’s biggest festivals, and ultimately leave behind a record of the music I love.</p>
                            <p className="bioText">You may be wondering what someone who works full time in marketing and writes articles on the weekend would do with what little free time they have left? <b>Obviously, the only reasonable answer is to go to night school for web development</b> , cause who needs sleep when they keep coming out with more delicious flavors of coffee.</p> 
                        </div>
                        <img id="aboutMePicBreak" src={ProfilePic} />
                        <div className="textSection">
                            <h3 className="bioBold"><b>Beeps and Boops</b></h3>
                        ...
                        <div className="textSection">
                            <h3 className="bioBold"><b>To be continued!</b></h3>
